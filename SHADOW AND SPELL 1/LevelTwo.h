int LevelTwo(int damage, int plyrHlth) // this UDF serves to keep all the code for level 1 separate from main for concise
{               // Opens UDF
	...
	cout << "\nGhoul: I will make sure to possess all your citizens and consume their very souls" << endl;  // Prints the enemy's dialogue
    ...
    {                                          // opens loop
        ...
        cout << "Player Health: " << plyrHlth << " | Ghoul Health: " << enemyHlth << endl;       // prints both player's and enemy's health
        cout << "Enemy deals ";                                                                  // this prints the enemy deals
        tempPoints = rand() % 15 + 10;                                                            // a temporary points is initialized to a rand() statement to determine how much damage has the player received
