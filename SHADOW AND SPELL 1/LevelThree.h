int LevelThree(int damage, int plyrHlth) // this UDF serves to keep all the code for level 1 separate from main for concise
{               // Opens UDF
	...
	cout << "\nJack: A hero coming to defeat Zahthorn? You will ll fail miserably and I will destroy this kingdom!" << endl;  // Prints the enemy's dialogue
    ...
    {                                          // opens loop
        ...
        cout << "Player Health: " << plyrHlth << " | Jack Health: " << enemyHlth << endl;        // prints both player's and enemy's health
        cout << "Enemy deals ";                                                                  // this prints the enemy deals
        tempPoints = rand() % 25 + 15;                                                            // a temporary points is initialized to a rand() statement to determine how much damage has the player received
	...
	cout << "Player Health: " << plyrHlth << " | Jack Health: " << enemyHlth << endl;       // prints both player's and enemy's health
        ...
        {                                                               // opens statement
            ...
            {                                                                                                    // opens statement
                cout << "Jack: You imbecil! You can never defeat an evil being like me! Zahthorn will rule!" << endl;  // prints a death dialogue for enemy
                this_thread::sleep_for(chrono::seconds(4));                                                      // this delays the print of text to help the player read properly what is on the screen
